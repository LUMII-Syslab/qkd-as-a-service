...
public class InjectableQaasKEM implements KEM {
    ...
    public InjectableQaasKEM(QkdProperties qkdProperties, InjectionPoint injectionPoint, InjectableAlgorithms algs) {
    ...
    public Pair<byte[], byte[]> keyGen() throws Exception {
        System.out.println("QAAS KEM KEYGEN (CLIENT)");
    ...
    public Pair<byte[], byte[]> encapsulate(byte[] partnerPublicKey) throws Exception {
        System.out.println("QAAS KEM ENCAPSULATE (SERVER)");
    ...
    public byte[] decapsulate(byte[] secretKey, byte[] ciphertext) throws Exception {
        System.out.println("QAAS KEM DECAPSULATE (CLIENT)");
