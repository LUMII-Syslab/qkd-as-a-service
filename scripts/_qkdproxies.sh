...
export ARGS="-f $PROJ_ROOT/scripts/pqproxy-local2pqccentis4aija.properties"
term "java -cp $JAVA_CP -Djava.library.path=$JAVA_LP $MAIN_CLASS $ARGS"

export ARGS="-f $PROJ_ROOT/scripts/pqproxy-local2pqccentis4brencis.properties"
term "java -cp $JAVA_CP -Djava.library.path=$JAVA_LP $MAIN_CLASS $ARGS"

export ARGS="-f $PROJ_ROOT/scripts/pqproxy-pqccentis2aija.properties"
term "java -cp $JAVA_CP -Djava.library.path=$JAVA_LP $MAIN_CLASS $ARGS"

export ARGS="-f $PROJ_ROOT/scripts/pqproxy-pqccentis2brencis.properties"
term "java -cp $JAVA_CP -Djava.library.path=$JAVA_LP $MAIN_CLASS $ARGS"
